...
from trainer.plugin_bases import Plugin
from trainer.plugin_bases import Monitor
from trainer.plugin_bases import LossMonitor
...
class SaverPlugin(Plugin):
    ...
    def epoch(self, epoch_index):
        ...
        print("=========")
        print(epoch_index)
        print(self.trainer.model.state_dict())
        torch.save(
